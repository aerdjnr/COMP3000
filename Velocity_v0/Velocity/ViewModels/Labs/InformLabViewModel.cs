...
{
    public partial class InformLabViewModel : ViewModelBase
    {
        public override double? SetWidth => 800;
        public override double? SetHeight => 575;

        private readonly MainWindowViewModel _main;
        public InformLabViewModel(MainWindowViewModel main)
        {
            _main = main;
            InfoLabQBank();
        }

        private readonly InfoLabCommands _givenCommand = new();
        ...
        public bool One_Net()
        {
            InfoLabCommands info = _givenCommand;
